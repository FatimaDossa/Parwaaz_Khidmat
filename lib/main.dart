...
//       useInheritedMediaQuery: true, // VERY IMPORTANT for dynamic orientation
...
//           title: 'Game App Demo',
//           theme: ThemeData(primarySwatch: Colors.red),
//           home: const GameStartScreen(), // Or your actual game start screen
//           // home: const GameStartScreen(),
//         );
//       },
//     );
...
import 'package:flutter_application_1/screens/cover_page.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<User?>(
      ...
      builder: (context, snapshot) {
        // 1. Show loading while waiting for auth state
        ...
        // 3. Logged in → check user type from Firestore
        ...
        return FutureBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (userType == 'SUNSHINE') {
              ...
              return ButterflyDashboard();
            } else {
              return const Scaffold(body: Center(child: Text('Unknown user type')));
            }
          },
        );
      },
